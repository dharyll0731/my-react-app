...
import CICTFiles from '../CICT-Files.pdf';
import CICTRRS from '../CICT-RRS.pdf';
            ...
            <div className="col-12 col-md-6 d-flex flex-column mt-5 text-md-left">
              ...
              >
                <motion.button
                  ...
                  animate="visible"
                >
                  <a href={resume} download="Dharyll_Flores Resume" className="text-decoration-none">
                    <h1 className="fs-5 mt-2" style={{ color: "#bcf002" }}>
                      Download CV
                    </h1>
                  </a>
                </motion.button>
                <a href="#section4" className="btn fs-5 col-12 col-md-3 text-dark" style={{ backgroundColor: "#bcf002", textDecoration: "none" }}>
              ...
              <div className="col-12 resume align-items-center justify-content-center mb-3">
                <div className="row expands mb-3">
                  ...
                  >
                    ...
                    {/* Downloadable title */}
                    <a href={CICTFiles} download className="text-decoration-none">
                      <h1 className="fs-5 mt-2" style={{ color: "#bcf002" }}>
                  ...
                  >
                    ...
                    <a href={CICTRRS} download className="text-decoration-none">
                      <h1 className="fs-5 mt-2" style={{ color: "#bcf002" }}>
